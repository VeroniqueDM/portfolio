import boutique from '../../images/BoutiqueBuzz.png';
    ...
    return (
        <div id="projects">
            <section class="projects">
                ...
                <article class="project-card arthub">
                        {/* <img src="../images/BoutiqueBuzzPreview.png" alt="project-img" /> */}
                        {/* <img src="/images/BoutiqueBuzzPreview.png" alt="project-img" /> */}
                       
                        <img src={arthub} alt="project-img" />

                        <div>
                            <a
                                href="https://art-hub-rho.vercel.app/"
                                target="_blank"
                            ...
                            <a
                                href="https://github.com/VeroniqueDM/ArtHub"
                                target="_blank"
                                rel="nooper noreferrer"
                            >
                                <svg
                    ...
                    <article class="project-card boutique-buzz">
                        {/* <img src="../images/BoutiqueBuzzPreview.png" alt="project-img" /> */}
                        {/* <img src="/images/BoutiqueBuzzPreview.png" alt="project-img" /> */}
                        <img src={boutique} alt="project-img" />
                        ...
                        <div>
                            ...
                            <a
                                href="https://github.com/VeroniqueDM/boutiqueBuzz"
                                target="_blank"
                                rel="nooper noreferrer"
                            >
                                <svg
